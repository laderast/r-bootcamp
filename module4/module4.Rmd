...
Have you wondered what the hell the "..." is in function descriptions? Basically
when a function has "...", it means you can pass it additional arguments to
internal functions This is really useful when using things like apply and you
have a function that requires additional arguments.

**FINAL QUESTION**: This is a multi-part question:
